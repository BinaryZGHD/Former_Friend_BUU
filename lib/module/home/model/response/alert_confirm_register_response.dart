...
AlertConfirmRegisterResponse alertConfirmRegisterResponseFromJson(String str) => AlertConfirmRegisterResponse.fromJson(json.decode(str));
String alertConfirmRegisterResponseToJson(AlertConfirmRegisterResponse data) => json.encode(data.toJson());
class AlertConfirmRegisterResponse {
  AlertConfirmRegisterResponse({
    Head? head,
    Body? body,}){
    _head = head;
    _body = body;
  ...
  AlertConfirmRegisterResponse.fromJson(dynamic json) {
    _head = json['head'] != null ? Head.fromJson(json['head']) : null;
    _body = json['body'] != null ? Body.fromJson(json['body']) : null;
  }
  Head? _head;
  Body? _body;
  AlertConfirmRegisterResponse copyWith({  Head? head,
    Body? body,
  }) => AlertConfirmRegisterResponse(  head: head ?? _head,
    body: body ?? _body,
  );
  Head? get head => _head;
  Body? get body => _body;
