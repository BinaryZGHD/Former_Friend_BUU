...
ScreenHomeMoreBoardStudentResponse screenHomeMoreBoardStudentResponseFromJson(String str) =>
    ScreenHomeMoreBoardStudentResponse.fromJson(json.decode(str));
String screenHomeMoreBoardStudentResponseToJson(ScreenHomeMoreBoardStudentResponse data) => json.encode(data.toJson());

class ScreenHomeMoreBoardStudentResponse {
  ScreenHomeMoreBoardStudentResponse({
    Head? head,
    Body? body,
  }) {
    _head = head;
  ...
  ScreenHomeMoreBoardStudentResponse.fromJson(dynamic json) {
    _head = json['head'] != null ? Head.fromJson(json['head']) : null;
    _body = json['body'] != null ? Body.fromJson(json['body']) : null;
  }
  Head? _head;
  Body? _body;
  ScreenHomeMoreBoardStudentResponse copyWith({
    Head? head,
    Body? body,
  }) =>
      ScreenHomeMoreBoardStudentResponse(
