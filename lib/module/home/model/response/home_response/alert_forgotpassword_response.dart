...
AlertForgotPasswordrResponse alertForgotPasswordrResponseFromJson(String str) => AlertForgotPasswordrResponse.fromJson(json.decode(str));
...
class AlertForgotPasswordrResponse {
  ...
  Head? _head;
  Body? _body;
  AlertForgotPasswordrResponse copyWith({  Head? head,
    Body? body,
  }) => AlertForgotPasswordrResponse(  head: head ?? _head,
    body: body ?? _body,
  );
  Head? get head => _head;
  Body? get body => _body;
