...
ScreePdpaResponse screePdpaResponseFromJson(String str) => ScreePdpaResponse.fromJson(json.decode(str));
String screePdpaResponseToJson(ScreePdpaResponse data) => json.encode(data.toJson());
class ScreePdpaResponse {
  ScreePdpaResponse({
      Head? head, 
      Body? body,}){
    _head = head;
  ...
  ScreePdpaResponse.fromJson(dynamic json) {
    _head = json['head'] != null ? Head.fromJson(json['head']) : null;
    _body = json['body'] != null ? Body.fromJson(json['body']) : null;
  }
  Head? _head;
  Body? _body;
ScreePdpaResponse copyWith({  Head? head,
  Body? body,
}) => ScreePdpaResponse(  head: head ?? _head,
  body: body ?? _body,
);
  Head? get head => _head;
  Body? get body => _body;
