...
AlertLogoutHomeResponse alertLogoutHomeResponseFromJson(String str) => AlertLogoutHomeResponse.fromJson(json.decode(str));
...
class AlertLogoutHomeResponse {
  ...
  Head? _head;
  Body? _body;
AlertLogoutHomeResponse copyWith({  Head? head,
  Body? body,
}) => AlertLogoutHomeResponse(  head: head ?? _head,
  body: body ?? _body,
);
  Head? get head => _head;
  Body? get body => _body;
