...
class ScreenMoreResponse {
  ...
  Head? _head;
  Body? _body;
ScreenMoreResponse copyWith({  Head? head,
  Body? body,
}) => ScreenMoreResponse(  head: head ?? _head,
  body: body ?? _body,
);
  Head? get head => _head;
  Body? get body => _body;
...
/// screenInfo : {"textmore":"อื่นๆ","textboard":"ทำเนียบ","btnstd":"นิสิต","btntc":"อาจารย์","textabdepart":"เกี่ยวกับภาควิชา","btndeparthis":"ประวัติภาควิชา","btncou":"หลักสูตร","btnface":"เฟสบุ๊ค","btnweb":"เว็บไซต์","textsup":"สนับสนุน","btntermandcon":"เงื่อนไขและข้อตกลง","btnfaq":"คำถามที่พบบ่อย ","btnconus":"ติดต่อเรา","texturgo2":"You are going to","textright":"right ?","textyes":"Yes","textno":"No"}
...
/// btnstd : "นิสิต"
/// btntc : "อาจารย์"
/// textabdepart : "เกี่ยวกับภาควิชา"
/// btndeparthis : "ประวัติภาควิชา"
/// btncou : "หลักสูตร"
/// btnface : "เฟสบุ๊ค"
/// btnweb : "เว็บไซต์"
/// textsup : "สนับสนุน"
/// btntermandcon : "เงื่อนไขและข้อตกลง"
