...
ScreenMoreBoardStudentListResponse screenMoreBoardStudentListResponseFromJson(String str) => ScreenMoreBoardStudentListResponse.fromJson(json.decode(str));
...
class ScreenMoreBoardStudentListResponse {
  ...
  Head? _head;
  Body? _body;
  ScreenMoreBoardStudentListResponse copyWith({  Head? head,
    Body? body,
  }) => ScreenMoreBoardStudentListResponse(  head: head ?? _head,
    body: body ?? _body,
  );
  Head? get head => _head;
  Body? get body => _body;
