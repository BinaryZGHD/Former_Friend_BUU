...
ScreenMoreBoardStudentListDetailResponse screenMoreBoardStudentListDetailResponseFromJson(String str) => ScreenMoreBoardStudentListDetailResponse.fromJson(json.decode(str));
String screenMoreBoardStudentListDetailResponseToJson(ScreenMoreBoardStudentListDetailResponse data) => json.encode(data.toJson());
class ScreenMoreBoardStudentListDetailResponse {
  ScreenMoreBoardStudentListDetailResponse({
    Head? head,
    Body? body,}){
    _head = head;
    _body = body;
  ...
  ScreenMoreBoardStudentListDetailResponse.fromJson(dynamic json) {
    _head = json['head'] != null ? Head.fromJson(json['head']) : null;
    _body = json['body'] != null ? Body.fromJson(json['body']) : null;
  }
  Head? _head;
  Body? _body;
  ScreenMoreBoardStudentListDetailResponse copyWith({  Head? head,
    Body? body,
  }) => ScreenMoreBoardStudentListDetailResponse(  head: head ?? _head,
    body: body ?? _body,
  );
  Head? get head => _head;
  Body? get body => _body;
