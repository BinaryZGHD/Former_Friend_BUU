...
class Body {
  ...
  Body.fromJson(dynamic json) {
    _screeninfo = json['screeninfo'] != null
    ...
    _approverlist =
        json['approverlist'] != null ? json['approverlist'].cast<String>() : [];
  }
...
Screeninfo screeninfoFromJson(String str) =>
    Screeninfo.fromJson(json.decode(str));
...
class Screeninfo {
  ...
  Screeninfo copyWith({
    ...
    String? btnconfirm,
      ...
      Screeninfo(
        titleaddact: titleaddact ?? _titleaddact,
