...
class AddActivityScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => ActivityBloc()..add(AddActivityScreenInfoEvent()),
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<ActivityBloc, ActivityState>(listener: (context, state) {
        ...
        if (state is ActivityScreenInfoSuccessState) {
          ...
          return BuildAddActitivtyBody(context, _addActivityScreenApi,activityName,
            year,
            term,
            sDate,
            fDate,
...
BuildAddActitivtyBody(BuildContext context, AddActivityScreenApi? _addActivityScreenApi, TextEditingController activityName,
